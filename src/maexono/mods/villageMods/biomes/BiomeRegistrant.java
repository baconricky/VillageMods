...
public class BiomeRegistrant {
	...
	public static void addBiomeById(int id) {
		...
		if(biomeForId != null)
			...
			VillageBiomes.log.warning("Can't find biome with ID " + id);
	}
	...
	public static void addBiomeByName(String name){
		...
		if(biomeForId != null)
			...
			VillageBiomes.log.warning("Can't find biome with name " + name);
	}
	...
	public static void addBiomesByTypeName(String name){
		...
		if(type != null)
			...
			VillageBiomes.log.warning("Can't find type with name " + name);
	}
